...
"<p><input name=\"Text\" type=\"text\" value=\"文本框\" maxlength=\"16\"></p>"
"<p><input type=\"checkbox\" name=\"checkbox\" id=\"checkbox\">复选框</p>"
"<p><input name=\"radio\" type=\"radio\" id=\"radio\" value=\"ON\" checked>单选按钮 LEDON</p>"
"<p><input type=\"radio\" name=\"radio\" id=\"radio2\" value=\"OFF\">单选按钮 LEDOFF</p>"
...
"</select>下拉菜单</p>"
"<p><input type=\"submit\" name=\"button\" id=\"button\" value=\"提交\">提交</p>"
"</form></body></html>";
...
"<head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=gb2312\" />"
"<title>登陆成功</title></head><body>登陆成功<a href=\"index.htm\">进入</a>"
"</body></html>";

const char loginfail_html[] = 
"<!DOCTYPE html><html xmlns=\"http://www.w3.org/1999/xhtml\">"
"<head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=gb2312\" />"
"<title>登陆失败</title></head><body>登陆失败<a href=\"login.htm\">返回</a>"
"</body></html>";
