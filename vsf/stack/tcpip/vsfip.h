...
#define VSFIP_MODNAME						"vsf.stack.net.tcpip"

struct vsfip_modifs_t
{
	...
	void (*socket_cb)(struct vsfip_socket_t *socket,
	...
	vsf_err_t (*ip4_pton)(struct vsfip_ipaddr_t*, char*);
	...
	struct
	{
		...
		void (*arp_add_assoc)(struct vsfip_netif_t*, uint8_t, uint8_t*, uint8_t,
				uint8_t*);
	} netif;
};
...
#define VSFIP_MOD							\
	((struct vsfip_modifs_t *)vsf_module_load(VSFIP_MODNAME, true))
...
#define vsfip_buffer_reference				VSFIP_MOD->buffer_reference
#define vsfip_buffer_release				VSFIP_MOD->buffer_release
#define vsfip_netif_add						VSFIP_MOD->netif_add
#define vsfip_netif_remove					VSFIP_MOD->netif_remove
#define vsfip_init							VSFIP_MOD->init
#define vsfip_fini							VSFIP_MOD->fini
#define vsfip_socket						VSFIP_MOD->socket
#define vsfip_close							VSFIP_MOD->close
...
#define vsfip_tcp_send						VSFIP_MOD->tcp_send
#define vsfip_tcp_async_recv				VSFIP_MOD->tcp_async_recv
#define vsfip_tcp_recv						VSFIP_MOD->tcp_recv
#define vsfip_tcp_close						VSFIP_MOD->tcp_close
#define vsfip_udp_async_send				VSFIP_MOD->udp_async_send
#define vsfip_udp_send						VSFIP_MOD->udp_send
#define vsfip_udp_async_recv				VSFIP_MOD->udp_async_recv
#define vsfip_udp_recv						VSFIP_MOD->udp_recv
#define vsfip_ip4_pton						VSFIP_MOD->ip4_pton
#define vsfip_input_sniffer					VSFIP_MOD->vsfip.input_sniffer
#define vsfip_output_sniffer				VSFIP_MOD->vsfip.output_sniffer
