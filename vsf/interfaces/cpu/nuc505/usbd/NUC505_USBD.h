...
extern const uint8_t nuc505_usbd_ep_num;
extern struct interface_usbd_callback_t nuc505_usbd_callback;
...
vsf_err_t nuc505_usbd_ep_set_type(uint8_t idx,
...
enum usb_ep_state_t nuc505_usbd_ep_get_IN_state(uint8_t idx);
...
vsf_err_t nuc505_usbd_ep_set_OUT_state(uint8_t idx, enum usb_ep_state_t state);
enum usb_ep_state_t nuc505_usbd_ep_get_OUT_state(uint8_t idx);
